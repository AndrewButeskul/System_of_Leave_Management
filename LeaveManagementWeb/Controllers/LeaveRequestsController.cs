...
namespace LeaveManagementWeb.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,DateOfExpiry,LeaveTypeId,DateRequasted,RequestComments,Approved,Cancelled,RequestingEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
        {
